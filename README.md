...
3. Додай канали за @username у тій самій панелі.
4. Ключі й сесія зберігаються лише в `localStorage` браузера. У коді їх немає.

Використовуй окремий акаунт: Telegram може блокувати акаунти за автоматизований доступ.

## Дані

Тривоги по областях беруться з тих самих каналів (повідомлення «повітряна тривога» / «відбій»). Публічні API тривог (ubilling, alerts.in.ua, ukrainealarm) не віддають CORS-заголовки, тому з браузера без бекенда недосяжні.
